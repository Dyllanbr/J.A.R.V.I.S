...
Decisões futuras observarão finalidade, adequação, necessidade/minimização, livre acesso, qualidade dos dados, transparência, segurança, prevenção, não discriminação, responsabilização e prestação de contas.

Nenhum fluxo futuro deve coletar CPF, data de nascimento, endereço ou outro dado pessoal apenas por conveniência, validação de senha ou validação de PIN.

## Mudança de contexto

Antes de qualquer beta com terceiros, o [LGPD Readiness Gate](privacy-by-design-checklist.md) deve estar concluído, com revisão jurídica e aprovação formal. Bases legais, papéis, retenção e fornecedores serão definidos somente a partir dos tratamentos reais; nada disso está definido ou implementado nesta fundação.

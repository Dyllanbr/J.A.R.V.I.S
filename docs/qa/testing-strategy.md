...
O simulador “Posso comprar?” do Incremento 6 está **VERIFICADO** dentro do escopo entregue. A evidência cobre Domain/Application, PostgreSQL read-only, POST `/v1/purchase-simulations`, OpenAPI 0.13.0, iOS na área de Cartões, compra à vista/parcelada, impacto e premissas, teste real e regressões dos fluxos de cartões. O PR #86 foi mergeado com sucesso na `main` no commit `5691351c5cb462d1abf6e1d50e68354ae7be522`; os gates Go e iOS do CI passaram. Metas e valores protegidos permanecem planejados.

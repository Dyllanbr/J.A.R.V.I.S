...
Os Incrementos 1 — Despesas, 2 — Receitas, 3A — Categorias e filtros do histórico, 3B — Recorrências confirmadas e assinaturas e 3C — Detecção e sugestão de recorrências estão **Verified**, assim como as subcapacidades 4A — CreditCard e 4B — CardPurchase + InstallmentPlan, o Incremento 5 — Orçamento mensal e Disponível Seguro e o simulador “Posso comprar?” do Incremento 6. O Incremento 6 também possui a declaração backend de metas financeiras e valores protegidos **Implemented**, ainda sem experiência iOS e sem classificação Verified. O restante do Incremento 4 e a visão futura continuam separados como capacidades planejadas no Product Book.

...
Estado: **Incrementos 1, 2, 3A, 3B, 3C, 4A, 4B e 5 verificados** dentro de seus escopos; o simulador “Posso comprar?” do Incremento 6 também está verificado com auditoria independente e quality gates correspondentes. As declarações backend e a experiência iOS de consulta de metas financeiras e valores protegidos foram implementadas nas Stages 1–4 do Incremento 6; E2E iOS dedicado, progresso e alertas permanecem planejados. O Incremento 4B foi mergeado na `main` pelo PR #75, commit `526cc855`; o Incremento 5 foi concluído com Safe Available, Monthly Budget e harness E2E real.
...
- área de **Cartões** com CreditCard ativo/arquivado e operações explícitas;
- compra no cartão à vista e parcelada, com `CardPurchase` e `InstallmentPlan`;
- listagem, detalhe, cancellation preview e cancelamento de InstallmentPlan;
...
- consulta de metas financeiras e valores protegidos na área de Histórico, com decoding estrito, estados de carregamento/vazio/erro e acessibilidade;
...
- não há autenticação, token, Face ID, passkey, PIN ou Keychain; o owner continua sendo contexto server-side single-owner temporário;
